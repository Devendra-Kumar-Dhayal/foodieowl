                        ...
                        <div class="resturant--info-address">
                            <div class="avatar avatar-xxl avatar-circle avatar-border-lg">
                                <img class="avatar-img"
                                    ...
                                    src="{{asset('storage/app/public/vendor')}}/{{$restaurant->vendor->image}}"
            ...
            <div class="col-lg-12  mt-2">
                <div class="card ">
                    ...
                    <div class="card-header justify-content-between align-items-center">
                        ...
                        <h5 class="card-title m-0 d-flex align-items-center">
                            <span class="card-header-icon mr-2">
                                <img src="{{ asset('/public/assets/admin/img/company.png') }}"
                                    alt="">
                            </span>
                            ...
                            <span class="ml-1">{{ translate('Additional_Information') }}  <span data-toggle="tooltip" data-placement="right"
                                ...
                                <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="info"></span> </span>
                        </h5>
                    </div>
                                        ...
                                        @if (in_array($f_date, ['pdf', 'doc', 'docs', 'docx' ]))
                                                @if ($f_date == 'pdf')
                                                    ...
                                                    <div class="attachment-card  min-w-260">
                                                        ...
                                                        <a href="#" class="pdf-info">
                                                            <img src="{{ asset('/public/assets/admin/new-img/doc.png') }}" alt="">
                                                            <div class="w-0 flex-grow-1">
